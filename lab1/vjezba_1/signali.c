...
int main()
{
    printf("Za ugasit program potreban je prekid razine 6\n");
    printf("Prekid se izaziva signalom sigint, koji se moze poslat sa Ctrl+C\n");
...
void emptyCounter(int signalPriority)
{
    ...
    printf("Zavrsio prekid razine: %d\n", signalPriority);
